...
var it = <Language> {
    ...
    seed_phrase_monero: "Parole di Recupero Monero",
    wrote_it_down: 'Le ho annotate',
    generate: 'Genera',
    warning: 'Attenzione',
    we_will_generate_bitcoin: 'Genereremo per te 12 parole di recupero Bitcoin.',
    we_will_generate_monero: 'Genereremo per te 12 parole di recupero Monero.',
