...
var ca = <Language> {
    ...
    seed_phrase_monero: "Llavor Monero(paraules de seguretat)",
    wrote_it_down: "L’he guardat",
    generate: 'Generar',
    warning: 'Advertència',
    we_will_generate_bitcoin: 'Es generaran 12 paraules de seguretat Bitcoin.',
    we_will_generate_monero: 'Es generaran 12 paraules de seguretat Monero.',
