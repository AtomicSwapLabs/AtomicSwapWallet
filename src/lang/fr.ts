...
var fr = <Language> {
    ...
    seed_phrase_monero: "Phrase de récupération Monero",
    wrote_it_down: 'Je l\'ai écrit',
    generate: 'Générer',
    warning: 'Attention',
    we_will_generate_bitcoin: 'Nous allons vous générer une phrase de récupération composée de 12 mots Bitcoin.',
    we_will_generate_monero: 'Nous allons vous générer une phrase de récupération composée de 12 mots Monero.',
