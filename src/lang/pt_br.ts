...
var pt_br = <Language> {
    ...
    seed_phrase_monero: "Palavras de Recuperação Monero",
    wrote_it_down: 'Eu anotei',
    generate: 'Gerar',
    warning: 'Aviso',
    we_will_generate_bitcoin: 'Nós vamos gerar 12 palavras de recuperação para você bitcoin.',
    we_will_generate_monero: 'Nós vamos gerar 12 palavras de recuperação para você bitcoin.',
