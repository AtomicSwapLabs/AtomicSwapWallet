...
var es = <Language> {
    ...
    seed_phrase_monero: "Frase Semilla Monero",
    wrote_it_down: 'La he guardado',
    generate: 'Generar',
    warning: 'Alerta',
    we_will_generate_bitcoin: 'Vamos a generar 12 palabras de recuperación (frase semilla) Bitcoin.',
    we_will_generate_monero: 'Vamos a generar 12 palabras de recuperación (frase semilla) Monero.',
