<template>
  <Screen>
    <ScreenContent>
      <CreateStep1Bitcoin v-if="!generated"/>
      <div v-if="generated">
        <CreateStep2Bitcoin/>
...
import CreateStep1Bitcoin from "@/components/CreateStep1Bitcoin.vue";
import CreateStep2Bitcoin from "@/components/CreateStep2Bitcoin.vue";
...
export default class CreateBitcoin extends Vue {
