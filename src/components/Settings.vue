<template>
  <Screen class="settings">
    ...
    <Footer>
      ...
      <ButtonSecondary :click="showSeedMonero" style="margin-left='-30px'">{{ language.show_seed_monero }}</ButtonSecondary>
...
export default class Settings extends Vue {
  ...
  private languages = ["English"].filter((l) => l != Utils.languageBigName(this.module.settings.language))
